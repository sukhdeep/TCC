...
class Paymentmode(models.Model):
	cash = models.IntegerField(editable=True, null=True)
	cheques = models.IntegerField(editable=True, null=True)
        demand_draft = models.IntegerField(editable=True, null=True)
